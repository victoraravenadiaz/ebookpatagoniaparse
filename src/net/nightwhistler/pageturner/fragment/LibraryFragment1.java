...
public class LibraryFragment1 extends RoboSherlockFragment implements ImportCallback {
...
*/
    ...
    private class BookCaseAdapter extends KeyedResultAdapter {
        ...
        public View getView(final int index, final LibraryBook object, View convertView,
            ...
            result.setOnClickListener( v -> LibraryFragment1.this.onItemClick(null, null, index, 0) );
            result.setOnLongClickListener( v -> LibraryFragment1.this.onItemLongClick(null, null, index, 0));
